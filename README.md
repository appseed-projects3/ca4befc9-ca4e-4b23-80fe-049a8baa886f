...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-11 12:27`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ca4befc9-ca4e-4b23-80fe-049a8baa886f.git
$ cd ca4befc9-ca4e-4b23-80fe-049a8baa886f
```
